...
const char* ssid = "2A1R";  // Nome da rede Wi-Fi
const char* password = "Anderson76"; // Senha do Wi-Fi
const char* server = "https://nova-scarce-ceramic.glitch.me/"; // URL do servidor
